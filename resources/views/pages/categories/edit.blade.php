                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="edit-uz-content" role="tabpanel">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="edit_uz_description" name="translations[uz][description]" rows="3" placeholder="Описание на Ўзбек"></textarea>
                                <small class="text-muted"><span class="edit-char-count-uz">0</span>/1000 символов</small>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="edit-ru-content" role="tabpanel">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="edit_ru_description" name="translations[ru][description]" rows="3" placeholder="Описание на Русский"></textarea>
                                <small class="text-muted"><span class="edit-char-count-ru">0</span>/1000 символов</small>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="edit-kk-content" role="tabpanel">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="edit_kk_description" name="translations[kk][description]" rows="3" placeholder="Описание на Қарақалпақ"></textarea>
                                <small class="text-muted"><span class="edit-char-count-kk">0</span>/1000 символов</small>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="edit-en-content" role="tabpanel">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" id="edit_en_description" name="translations[en][description]" rows="3" placeholder="Описание на English"></textarea>
                                <small class="text-muted"><span class="edit-char-count-en">0</span>/1000 символов</small>
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    languages.forEach(function(lang) {
        $('#edit_' + lang + '_description').on('input', function() {
            var length = $(this).val().length;
            $('.edit-char-count-' + lang).text(length);
        });
    });
});
</script>
