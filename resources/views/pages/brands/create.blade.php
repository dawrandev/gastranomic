                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="uz-content" role="tabpanel">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('translations.uz.description') is-invalid @enderror" id="uz_description" name="translations[uz][description]" rows="4" placeholder="Краткое описание бренда">{{ old('translations.uz.description') }}</textarea>
                        ...
                        <div class="tab-pane fade" id="ru-content" role="tabpanel">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('translations.ru.description') is-invalid @enderror" id="ru_description" name="translations[ru][description]" rows="4" placeholder="Краткое описание бренда">{{ old('translations.ru.description') }}</textarea>
                        ...
                        <div class="tab-pane fade" id="kk-content" role="tabpanel">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('translations.kk.description') is-invalid @enderror" id="kk_description" name="translations[kk][description]" rows="4" placeholder="Краткое описание бренда">{{ old('translations.kk.description') }}</textarea>
                        ...
                        <div class="tab-pane fade" id="en-content" role="tabpanel">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('translations.en.description') is-invalid @enderror" id="en_description" name="translations[en][description]" rows="4" placeholder="Краткое описание бренда">{{ old('translations.en.description') }}</textarea>
